...
class GingerSlime // Slime name here
{
    ...
    {
        // DEFINE
        SlimeDefinition gingerDefinition = SRSingleton<GameContext>.Instance.SlimeDefinitions.GetSlimeByIdentifiableId(Identifiable.Id.PINK_SLIME); // make sure to make slimeNameDefiniton your slime name btw-
        SlimeDefinition slimeDefinition = (SlimeDefinition)PrefabUtils.DeepCopyObject(gingerDefinition);
        ...
        slimeDefinition.Name = "Ginger Slime";
        slimeDefinition.IdentifiableId = ModIds.GINGER_SLIME;
        // OBJECT
        ...
        slimeObject.GetComponent<Identifiable>().id = ModIds.GINGER_SLIME;
        ...
        SlimeAppearance slimeAppearance = (SlimeAppearance)PrefabUtils.DeepCopyObject(gingerDefinition.AppearancesDefault[0]);
        ...
        slimeAppearance.Icon = CreateSprite(LoadImage("ginger_slime.png"));
        ...
        PediaRegistry.RegisterIdEntry(ModIds.GINGER_ENTRY, CreateSprite(LoadImage("ginger_slime.png")));
